            ...
            <div className="mx-auto max-w-7xl">
                ...
                <div className="mt-6 grid gap-6 lg:grid-cols-2">
                    ...
                    <form onSubmit={handleSubmit} className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                        ...
                        <input value={phone} onChange={(e) => setPhone(e.target.value)} className="mt-1 w-full rounded-md border border-slate-200 px-3 py-2" />

                        <label className="mt-4 block text-sm font-medium text-slate-700">Delivery address</label>
                        <textarea value={address} onChange={(e) => setAddress(e.target.value)} className="mt-1 w-full rounded-md border border-slate-200 px-3 py-2" rows={4} />
                        ...
                        <div className="mt-6 flex items-center gap-6">
                            <div>
                                ...
                                <Image src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(qrData)}`} alt="QR code" className="mt-2 h-40 w-40 rounded-md bg-white p-2" unoptimized width={200} height={200} />
                            </div>
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-6">
                                    <button disabled={loading} type="submit" className="inline-flex items-center rounded-md bg-slate-950 px-4 py-2 text-sm font-semibold text-white">
